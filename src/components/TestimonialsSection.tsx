...
const TestimonialsSection = () => {
  return (
    <section className="py-20 overflow-hidden testimonial-section-light">
      <div className="container px-4">
        ...
        >
          <h2 className="text-5xl font-normal mb-4 text-foreground">Trusted by Crypto Investors</h2>
          <p className="text-muted-foreground text-lg">
            Join thousands of satisfied investors on Treefolio
          </p>
        </motion.div>
          ...
          <div className="relative flex overflow-hidden py-4">
            <div className="animate-marquee flex min-w-full shrink-0 items-stretch gap-8">
              {testimonials.map((testimonial, index) => (
                <Card key={`${index}-1`} className="w-[400px] shrink-0 testimonial-card-light p-8">
            ...
            <div className="animate-marquee flex min-w-full shrink-0 items-stretch gap-8">
              {testimonials.map((testimonial, index) => (
                <Card key={`${index}-2`} className="w-[400px] shrink-0 testimonial-card-light p-8">
                  <div className="flex items-center gap-4 mb-6">
                    <Avatar className="h-12 w-12">
                      <AvatarImage src={testimonial.image} />
                      <AvatarFallback>{testimonial.name[0]}</AvatarFallback>
